...
Main.particleSystemChangeCallback = function ( InputSettings ) {
    ...
    var trails     = new Emitter( {
        ...
        particlesFreq: 100,  // how many particle per second will we emit?
        initialize:    initializer,                  // initializer object
        update:        updater,                      // updater object
        material:      InputSettings.particleMaterial,
        cloth:         false,
...
function mousedown(event) {
    ...
    plane2     = new THREE.Mesh( plane_geo, material );
    plane.up = new THREE.Vector3(0, 1, 0);
    plane2.up = new THREE.Vector3(0, -1, 0);
    plane.add(plane2);
...
function mousemove(event){
    ...
    if (down){
        ...
        setTimeout(function() {
            ...
            var neg_norm = new_norm.clone().normalize;
